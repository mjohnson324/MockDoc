...
# Simpsons
doc_hibbert_simpsons = Doctor.create!(first_name: "Julius", last_name: "Hibbert", education: "Johns Hopkins University School of Medicine", degree: "MD", address: "51 W 51st St, New York, NY", quote: "A-he-he-he!")
doc_nick_simpsons = Doctor.create!(first_name: "Nick", last_name: "Riviera", education: "Hollywood Upstairs Medical College", address: "51 W 42nd St, New York, NY", quote: "Hello Everybody!")
...
30.times do |i|
  rand_name = rand(39)
  rand_school = rand(8)
  doctors << Doctor.create!(first_name: random_first_name[rand_name], last_name: random_last_name[rand_name], education: random_school[rand_school], degree: "MD", address: addresses[i])
end
5.times do |i|
  rand_name = rand(39)
  rand_school = rand(8)
  doctors << Doctor.create!(first_name: random_first_name[rand_name], last_name: random_last_name[rand_name], education: dental_school, degree: "DMD", address: addresses[i + 100])
end
...
doctors.each_with_index do |doctor, j|
  ...
  200.times do |i|
    app = Appointment.create!(doctor_id: doctor.id, start_time: start_day.to_datetime, address: addresses[j])
    ...
    start_day += 2.hour
    start_day += 18.hour if start_day.hour > 14
  end
end